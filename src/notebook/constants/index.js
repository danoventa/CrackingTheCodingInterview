...
export const HIDE_CELL_OUTPUT = 'HIDE_CELL_OUTPUT';
export const SHOW_CELL_OUTPUT = 'SHOW_CELL_OUTPUT';
...
export const SET_FORWARD_CHECKPOINT = 'SET_FORWARD_CHECKPOINT';
export const SET_BACKWARD_CHECKPOINT = 'SET_BACKWARD_CHECKPOINT';
